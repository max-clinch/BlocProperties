...
async function simulateDeployAdmin(ProxyAdminFactory, opts, adminAddress) {
...
async function simulateDeployImpl(Contract, opts, implAddress) {
...
async function getSimulatedData(Contract, opts, implAddress) {
    const deployData = await (0, deploy_impl_1.getDeployData)(opts, Contract);
